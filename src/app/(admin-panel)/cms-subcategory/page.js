...
//   // Names helper
//   const getCatName = (id) => categories.find(c => String(c.id) === String(id))?.categoryName || `ID: ${id}`;
//   const getSubName = (id) => allSubcategories.find(s => String(s.id) === String(id))?.subcategoryName || `ID: ${id}`;
...
//     setModal(!modal);
//     if (!modal) {
//       setFormData({ adminId: "3", categoryId: "", subcategoryId: "", content: "" });
//       setIsEditing(false);
//     }
//   };
...
//   const currentItems = cmsSubList.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);
...
//           <p className="text-muted small">Manage landing page content for sub-services.</p>
//         </div>
//         <Button style={{ backgroundColor: GOLD, border: 'none', color: '#fff' }} className="px-4 shadow-sm fw-bold" onClick={toggle}>
//           + Add Service Detail
//         </Button>
//       </div>
...
//                     <td className="text-muted small">{getCatName(item.categoryId)}</td>
                    
//                     {/* Yahan se Badge hata kar simple black text kar diya gaya hai */}
...
//                   </tr>
//                 ))}
//                 {cmsSubList.length === 0 && <tr><td colSpan="5" className="text-center py-5">No Records Found</td></tr>}
//               </tbody>
//             </Table>
//           </div>
//         </CardBody>
...
//       <div className="mt-3">
//         <PaginationComponent totalItems={cmsSubList.length} itemsPerPage={itemsPerPage} currentPage={currentPage} onPageChange={setCurrentPage} />
//       </div>

//       {/* MODAL */}
//       <Modal isOpen={modal} toggle={toggle} centered size="lg">
//         <ModalHeader toggle={toggle} className="border-0 pb-0">
//             <span className="fw-bold" style={{ color: GOLD }}>{isEditing ? "Edit" : "Add"} Service Content</span>
//         </ModalHeader>
...
//                   <Input type="select" value={formData.categoryId} onChange={e => setFormData({...formData, categoryId: e.target.value, subcategoryId: ""})} required>
...
//               <Button type="submit" style={{ backgroundColor: GOLD, border: 'none', width: '150px', color: '#fff' }} className="fw-bold" disabled={loading}>
//                 {loading ? "Saving..." : "Save Content"}
//               </Button>
//               <Button outline onClick={toggle} style={{ width: '120px' }}>Cancel</Button>
//             </div>
//           </Form>
//         </ModalBody>
//       </Modal>
